...
function createSoldier(typeId, level, atkMul = 1, hpMul = 1) {
  ...
  return {
    ...
    shield: 0,
    maxShield: 0,
    armor: (typeof roleStats === 'function' ? roleStats(t.role).armor : (t.armor || 0)),
    siege: (typeof roleStats === 'function' ? roleStats(t.role).siege : (t.siege || 1)),
    move: (typeof roleStats === 'function' ? roleStats(t.role).move : (t.move || 86)),
    slowTimer: 0,
    slowMul: 1,
    firstHit: true,
    skillTimer: 0,
