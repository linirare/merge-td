...
function createSoldier(typeId, level, atkMul = 1, hpMul = 1) {
  ...
  return {
    ...
    shield: 0,
    maxShield: 0,
    armor: (t.armor != null ? t.armor : (typeof roleStats === 'function' ? roleStats(t.role).armor : 0)),
    siege: (t.siege != null ? t.siege : (typeof roleStats === 'function' ? roleStats(t.role).siege : 1)),
    move: (t.move != null ? t.move : (typeof roleStats === 'function' ? roleStats(t.role).move : 86)),
    slowTimer: 0,
    slowMul: 1,
    firstHit: true,
    skillTimer: 0,
...
function createState() {
  return {
    ...
    enemyReefShieldUsed: false,
    playerReefShieldUntil: 0,
    enemyReefShieldUntil: 0,
